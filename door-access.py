...
### Check whitelist
	if ID_list.count(ss) > 0:
		...
		print('Welcome '+names_list[pos])

		led.on()  # Activate the relay to unlock the door
		sleep(2)
		led.off()
		...
		#bashCommand = 'rclone copy /home/pi/RFID/log-door.csv door-log:backup'
		#os.system(bashCommand)

		#os.system('/home/pi/RFID/upload-log.sh')
	...
	#subprocess.call('/home/pi/RFID/upload-log.sh')
	#os.system('/home/pi/RFID/upload-log.sh')
